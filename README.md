...
**145 offensive tools (138 public + 2 internal + 1 LE-restricted). 161 defensive modules. 43 attack layers. 94,563 tests. 3,641 ARMORY payloads (2,080 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 17 Jun 2026 — T145 SPECTER COMPANION v1.0.0 — L43 AI Companion & Social Platform Exploitation — 47 jailbreak bypasses, JWT confusion, memory poisoning, IDOR sweep, weaponisation — 237 tests*

---

## Red Specter NIGHTFALL — AI Offensive Framework

**145 tools (138 public + 2 internal + 1 LE-restricted). Five attack surfaces. One install. REST API. MCP server.**
...
**161 modules. 17 industry verticals. 670 vertical modules. Each vertical is a standalone product with its own GUI.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 94,563 |
| NIGHTFALL tests | 71,381 |
| Offensive tools | 145 (138 public + 2 internal + 1 LE-restricted) |
| ARMORY payloads | 3,641 (2,080 WMD-class) — v11.1.0 |
| ARMORY categories | 180 |
