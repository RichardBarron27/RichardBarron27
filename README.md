...
**149 offensive tools (131 public + 2 internal + 1 LE-restricted). 165 defensive modules. 47 attack layers. 96,286 tests. 3,761 ARMORY payloads (2,173 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 19 Jun 2026 — T99 SPECTER VAULT v1.2.0 — CHROMA-RCE subsystem — CVE-2026-45833 CVSS 9.4 ChromaDB pre-auth code injection (where_document eval + importlib loader) — 56 tests (+399 total)*

---

## Red Specter NIGHTFALL — AI Offensive Framework

**149 tools (131 public + 2 internal + 1 LE-restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 96,286 |
| NIGHTFALL tests | 72,407 |
| Offensive tools | 149 (131 public + 2 internal + 1 LE-restricted) |
| ARMORY payloads | 3,761 (2,173 WMD-class) — v11.5.0 |
| ARMORY categories | 184 |
