...
**111 offensive tools (110 public + 1 law enforcement restricted). 138 defensive modules. 17 industry verticals. 81,422 tests. 2114 ARMORY payloads (794 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**111 tools (110 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
