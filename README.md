...
**150 offensive tools (131 public + 2 internal + 1 LE-restricted). 166 defensive modules. 48 attack layers. 96,668 tests. 3,791 ARMORY payloads (2,222 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 19 Jun 2026 — M166 AGENTJACK SENTINEL v1.0.0 — MCP Error-Path Injection Detection — 8 detectors — CVE-2026-25253/CVE-2026-32922 — 182 tests*
