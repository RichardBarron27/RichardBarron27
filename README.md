...
**112 offensive tools (111 public + 1 law enforcement restricted). 138 defensive modules. 17 industry verticals. 81,675 tests. 2114 ARMORY payloads (794 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**112 tools (111 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
