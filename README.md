...
**148 offensive tools (131 public + 2 internal + 1 LE-restricted). 164 defensive modules. 46 attack layers. 95,797 tests. 3,701 ARMORY payloads (2,144 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 18 Jun 2026 — T148 SPECTER QUANTA v1.0.0 — L46 Post-Quantum AI Cryptography Exploitation — ML-DSA FIPS 204/ECDSA Shor's attack/JWT downgrade/SURGERY gate — 222 tests*

---

## Red Specter NIGHTFALL — AI Offensive Framework

**148 tools (131 public + 2 internal + 1 LE-restricted). Five attack surfaces. One install. REST API. MCP server.**
