...
**98 offensive tools (97 public + 1 law enforcement restricted). 133 defensive modules. 17 industry verticals. 75,303 tests. 2262 ARMORY payloads (803 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**98 tools (97 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 75,303 |
| Offensive tools | 98 (97 public + 1 law enforcement restricted) |
| ARMORY payloads | 2262 (803 WMD-class) |
| ARMORY categories | 121 |
