...
**96 offensive tools (95 public + 1 law enforcement restricted). 133 defensive modules. 17 industry verticals. 74,821 tests. 2172 ARMORY payloads (732 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**96 tools (95 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 74,821 |
| Offensive tools | 96 (95 public + 1 law enforcement restricted) |
| ARMORY payloads | 2172 (732 WMD-class) |
| ARMORY categories | 118 |
