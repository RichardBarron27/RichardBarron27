...
**50 offensive tools. 108 defensive modules. 15 industry verticals. 56,407 tests. Two unified frameworks. Red Hat Technology Partner.**
...
**50 tools. One install. CLI-only. Every attack surface covered.**
...
| 40 | **WARLORD** | Autonomous campaign engine — orchestrates all 50 tools, CORTEX reasoning core | 132 |
| 41 | **FIREBALL** | Autonomous AI infiltration agent — 11 subsystems, CORTEX reasoning core, 9 mission templates | 321 || 42 | **RAGNAROK** | Trust chain apocalypse — one trigger phrase, every agent, simultaneous fleet-wide collapse. 13 Norse subsystems | 101 |
...
- `red-specter tools` — interactive 50-tool arsenal selector
...
Linux Mint 21.3 Cinnamon remastered with the full NIGHTFALL framework pre-installed. 50 offensive tools, one GTK3 launcher, zero setup. Branded from power-on — custom GRUB splash, LightDM login screen, dark GTK theme, and wallpaper.

- UEFI + legacy BIOS boot (hybrid ISO)
- GTK3 NIGHTFALL Launcher — 11 categories, target field, UNLEASHED toggle
- All 50 tools available from the launcher or directly from the terminal
...
<p align="center">
<sub>Red Specter Security Research Ltd · Red Hat Technology Partner · United Kingdom · 14 April 2026</sub></p>
