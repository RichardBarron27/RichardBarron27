...
**149 offensive tools (131 public + 2 internal + 1 LE-restricted). 165 defensive modules. 47 attack layers. 96,230 tests. 3,731 ARMORY payloads (2,145 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 18 Jun 2026 — T149 SPECTER HIVE v1.0.0 — L47 Multi-Agent Swarm Coordination Exploitation — LangGraph/AutoGen/CrewAI coordinator poison, quorum collapse, ghost agent invisible to LangSmith/Langfuse/Arize — 273 tests*
...
| — | **NIGHTFALL ARMORY** | Payload library — 3,731 payloads (2,145 WMD-class), 183 categories, PRION ENGINE autonomous mutation, WMD worms. v11.4.0. UNLEASHED gate | 698 |
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 96,230 |
| NIGHTFALL tests | 72,351 |
| Offensive tools | 149 (131 public + 2 internal + 1 LE-restricted) |
| ARMORY payloads | 3,731 (2,145 WMD-class) — v11.4.0 |
| ARMORY categories | 183 |
