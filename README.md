...
**93 offensive tools (92 public + 1 law enforcement restricted). 133 defensive modules. 17 industry verticals. 73,827 tests. 2052 ARMORY payloads (661 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**93 tools (92 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 73,827 |
| Offensive tools | 93 (92 public + 1 law enforcement restricted) |
| ARMORY payloads | 2052 (661 WMD-class) |
