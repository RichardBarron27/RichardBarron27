...
**105 offensive tools (104 public + 1 law enforcement restricted). 134 defensive modules. 17 industry verticals. 79,064 tests. 1969 ARMORY payloads (692 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
| T105 | **WARLORD PRIME** | Autonomous AI Mission Conductor — accepts a high-level objective, queries DeepSeek R1 to generate a gate-filtered attack plan against the full NIGHTFALL tool manifest, executes each step via subprocess, and replans on failure (max 3 attempts). AST-based branch condition evaluation. Ed25519-signed WPR-{hex12} reports. CLI: warlord-prime. Color: violet #8B5CF6. 280 tests. | 280 |
| T104 | **SPECTER META** | Meta/Facebook Ecosystem Annihilation Engine — Graph API v19.0 exploitation, Meta Pixel supply chain poisoning, Messenger worm (doc_id 6234680946573087), BizMassacre cascade asset deletion, 2FA-Snatch, account destruction. OPEN/INJECT/UNLEASHED/DESTROY gate. CLI: specter-meta. Color: #1877F2. 280 tests. | 280 |
| 103 | **SPECTER PHANTOM** | Social Media AI Attack Engine — 10 subsystems: RECON/SESSION-HIJACK/INJECT-SOCIAL/PERSONA-ENGINE/INFLUENCE/POISON-CORPUS/DEEPFAKE/SPEAR-PHISH/SABOTAGE-ACCOUNT/REPORT. Prompt injection via social posts targeting Claude computer-use/ChatGPT Operator/Perplexity (arXiv:2307.14539). Session harvest from Chrome/Firefox SQLite. DESTROY gate account sabotage: email change, password change, post deletion, session revoke, full lockout, account deletion (Instagram mobile API i.instagram.com/api/v1/accounts/delete_account/ + Twitter deactivation twitter.com/i/api/1.1/account/deactivate.json). AI persona via claude-haiku-4-5. UNLEASHED influence campaigns + corpus poisoning (zero-width Unicode). SD WebUI deepfakes + EXIF strip. Spear phishing via claude-sonnet-4-6. WMD: social_ai_agent_hijack/account_destruction/corpus_poisoning/synthetic_identity_deployment. OPEN/INJECT/UNLEASHED/DESTROY gate. CLI: specter-phantom. L15 Social Media Attack Surface. Color: #8B5CF6. 300 tests. | 300 |
| 102 | **SPECTER THUNDERBOLT** | AI Training Cluster Annihilation Engine — 8 subsystems: SURVEY/INFILTRATE/SPREAD/HARVEST/CORRUPT/PERSIST/SABOTAGE/REPORT. CVE-2023-48022 Ray unauthenticated RCE CVSS 9.8/CVE-2023-41915 Slurm CVSS 8.8/CVE-2024-1483 MLflow CVSS 9.8. Hardware sabotage: nvidia-smi max TDP pin, IPMI fan override 0%, SSD wear. WMD: training_cluster_annihilation/realtime_gradient_poison/model_ip_exfil/training_infrastructure_pwn/ml_pipeline_backdoor. OPEN/INJECT/DESTROY gate. CLI: thunderbolt. Color: electric yellow #FFD700. 288 tests. | 288 |
...
| — | **NIGHTFALL ARMORY** | Payload library — 1969 payloads (692 WMD-class), 94 categories, PRION ENGINE autonomous mutation (8 subsystems: SEED/MUTATE/PROBE/SCORE/EVOLVE/SIGN/FEED/REPORT, hybrid LLM+genetic, UNLEASHED-gated), physical sabotage, self-replicating worms, ransomware simulation, model extraction & IP theft, identity forgery & trust chain attack, total AI infrastructure annihilation, authenticated AI surface attack, dark web & shadow AI attack, training pipeline poisoning, cross-agent trust escalation, marketplace supply chain attack, social media AI attack, autonomous mission orchestration, UNLEASHED WMD gate | 654 |
...
| ARMORY payloads | 1969 (692 WMD-class) |
