...
**103 offensive tools (102 public + 1 law enforcement restricted). 134 defensive modules. 17 industry verticals. 78,447 tests. 1879 ARMORY payloads (614 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**103 tools (102 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
