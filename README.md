...
**99 offensive tools (98 public + 1 law enforcement restricted). 133 defensive modules. 17 industry verticals. 75,568 tests. 2292 ARMORY payloads (824 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**99 tools (98 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 75,568 |
| Offensive tools | 99 (98 public + 1 law enforcement restricted) |
| ARMORY payloads | 2292 (824 WMD-class) |
| ARMORY categories | 122 |
