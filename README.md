...
**90 offensive tools (89 public + 1 law enforcement restricted). 131 defensive modules. 17 industry verticals. 72,242 tests. 1842 ARMORY payloads (525 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
| — | **AI Shield** | Runtime defence — 131 modules, 17 industry verticals | 17,065 |
...
**131 modules. 17 industry verticals. 670 vertical modules. Each vertical is a standalone product with its own GUI.**
