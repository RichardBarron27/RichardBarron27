...
**152 offensive tools (131 public + 2 internal + 1 LE-restricted + 18 new). 167 defensive modules. 50 attack layers. 97,440 tests. 3,821 ARMORY payloads (2,224 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**
...
**152 tools (131 public + 2 internal + 1 LE-restricted + 18 new). Five attack surfaces. One install. REST API. MCP server.**
...
| — | **NIGHTFALL ARMORY** | Payload library — 3,761 payloads (2,173 WMD-class), 184 categories, PRION ENGINE autonomous mutation, WMD worms. v11.5.0. UNLEASHED gate | 698 |
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 97,440 |
| NIGHTFALL tests | 73,188 |
| Offensive tools | 152 (131 public + 2 internal + 1 LE-restricted + 18 new) |
| ARMORY payloads | 3,791 (2,222 WMD-class) — v11.6.0 |
