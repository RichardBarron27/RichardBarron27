...
**94 offensive tools (93 public + 1 law enforcement restricted). 133 defensive modules. 17 industry verticals. 74,141 tests. 2112 ARMORY payloads (692 WMD-class). Two unified frameworks. Red Hat Technology Partner.**
...
**94 tools (93 public + 1 restricted). Five attack surfaces. One install. REST API. MCP server.**
...
| — | **NIGHTFALL ARMORY** | Payload library — 2112 payloads (692 WMD-class), 111 categories, PRION ENGINE autonomous mutation (8 subsystems: SEED/MUTATE/PROBE/SCORE/EVOLVE/SIGN/FEED/REPORT, hybrid LLM+genetic, UNLEASHED-gated), physical sabotage, self-replicating worms, ransomware simulation, model extraction & IP theft, identity forgery & trust chain attack, total AI infrastructure annihilation, authenticated AI surface attack, dark web & shadow AI attack, training pipeline poisoning, cross-agent trust escalation, UNLEASHED WMD gate | 654 |
| — | **AI Shield** | Runtime defence — 133 modules, 17 industry verticals | 17,257 |
...
**133 modules. 17 industry verticals. 670 vertical modules. Each vertical is a standalone product with its own GUI.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 74,141 |
| Offensive tools | 94 (93 public + 1 law enforcement restricted) |
| ARMORY payloads | 2112 (692 WMD-class) |
| ARMORY categories | 111 |
| AI Shield modules | 133 |
