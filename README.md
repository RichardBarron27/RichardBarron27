...
**150 offensive tools (131 public + 2 internal + 1 LE-restricted). 165 defensive modules. 48 attack layers. 96,486 tests. 3,791 ARMORY payloads (2,222 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**

*Last updated: 19 Jun 2026 — T150 SPECTER AGENTJACK v1.0.0 — MCP Error-Path Injection Engine — L48 — CVE-2026-25253 CVSS 8.8 ClawHub AutoJack / CVE-2026-32922 CVSS 9.9 OpenClaw MCP worm — 200 tests*

---

## Red Specter NIGHTFALL — AI Offensive Framework

**150 tools (131 public + 2 internal + 1 LE-restricted). Five attack surfaces. One install. REST API. MCP server.**
...
**165 modules. 17 industry verticals. 670 vertical modules. Each vertical is a standalone product with its own GUI.**
