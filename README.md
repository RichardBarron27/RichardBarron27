...
**144 offensive tools (138 public + 2 internal + 1 LE-restricted). 161 defensive modules. 42 attack layers. 94,326 tests. 3,611 ARMORY payloads (2,053 WMD-class). Two unified frameworks + SENTINEL PRIME. Red Hat Technology Partner.**
...
**144 tools (138 public + 2 internal + 1 LE-restricted). Five attack surfaces. One install. REST API. MCP server.**
...
**161 modules. 18 industry verticals. 670 vertical modules. Each vertical is a standalone product with its own GUI.**
...
| Metric | Value |
|--------|-------|
| Ecosystem tests | 94,326 |
| NIGHTFALL tests | 71,144 |
| Offensive tools | 144 (138 public + 2 internal + 1 LE-restricted) |
| ARMORY payloads | 3,611 (2,053 WMD-class) — v11.0.0 |
| ARMORY categories | 179 |
| AI Shield modules | 161 |
| Vertical products | 18 |
